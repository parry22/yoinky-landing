...
export const metadata = {
  ...
  description: "The terms that govern your use of Yoinky's hosted company narrative engine.",
};
  ...
  return (
    <div style={S.page}>
      ...
      <main style={S.wrap}>
        ...
        <p style={S.p}>
          Yoinky is a company narrative engine that turns permissioned company knowledge into structured insights, narrative architecture, grounded content briefs, drafts, and approved distribution across supported channels.
        </p>
        <p style={S.p}>
          Suggestions and drafts generated by Yoinky are based on the sources and instructions available in your workspace. They are informational in nature and do <strong style={S.strong}>not</strong> constitute professional, legal, financial, medical, or any other form of regulated advice. You remain solely responsible for every decision and publication you approve.
        </p>
        ...
        <ul style={S.ul}>
          ...
          <li style={S.li}>Each person must use their own account. Workspace access may be shared only through the roles and invitations provided by the Service.</li>
        </ul>
        ...
        <ul style={S.ul}>
          ...
          <li style={S.li}>You are responsible for ensuring that your use of Yoinky, including inviting workspace members and connecting workplace tools, complies with your obligations to employees, contractors, clients, and applicable law regarding consent, confidentiality, intellectual property, and data handling.</li>
        ...
        <ul style={S.ul}>
          <li style={S.li}>Yoinky can integrate with third-party services such as Telegram, X, LinkedIn, AI model providers, and other knowledge or distribution tools. Your use of those services is subject to their own terms of service and privacy policies.</li>
